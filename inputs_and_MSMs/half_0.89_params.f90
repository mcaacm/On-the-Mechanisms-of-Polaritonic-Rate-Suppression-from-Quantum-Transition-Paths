...
! EXAMPLE INPUT FILE--NOTE 0.74 HAS BEEN MULTIPLIED BY RATIO!
! This is for half default light-matter coupling strength.
...
REAL*8, PARAMETER, DIMENSION(nbath) :: eta = (/0.001822766d0/) 
...
REAL*8, PARAMETER :: coeff_xi = 0.5d0*0.00234562*factor !0.1d0/27.211396d0
...
INTEGER, PARAMETER :: init_stat_therm = 1
! Eigenstate to initialize all density in if init_stat_therm = 1
INTEGER, PARAMETER :: init_es = 13
